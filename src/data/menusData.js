...
export const COCKTAIL_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Manhattan', ingr: 'Rye Whiskey, Sweet Vermouth, Bitters', price: '$15' },
      { name: 'Moscow Mule', ingr: 'Vodka, Lime Juice, Ginger Syrup, Fever Tree Ginger Beer', price: '$15' },
      { name: 'Sidecar', ingr: 'Hennessy, Triple Sec, Lemon', price: '$15' },
  ...
  },
  {
    ...
    label: 'Limited',
    items: [
      { name: 'Death by Coffe', ingr: 'Slane Irish Whiskey, Oat Milk, Simple Syrup, Coffee Vanilla Condensed Milk', price: '$13' },
...
export const SPIRITS = [
  {
    ...
    items: [
      ...
      { name: 'Clase Azul Anejo', price: '$80' },
      { name: 'Don Julio Blaco', price: '$15' },
      { name: 'Don Julio Repo', price: '$18' },
      { name: 'Don Julio Anejo', price: '$20' },
      { name: 'Don Julio 70', price: '$22' },
      ...
      { name: 'Patron Reposado', price: '$16' },
      { name: 'Patron Anejo', price: '$18' },
      { name: 'Patrón Extra Anejo', price: '$18' },
      { name: 'Patron Platinum', price: '$32' },
      { name: 'Volcán Blanco', price: '$14' },
      { name: 'Volcán Reposado', price: '$16' },
      { name: 'Volcán Cristalino', price: '$18' },
      { name: 'Volcán Smoke', price: '$15' },
    ],
  },
  {
    name: 'Rum, Gin',
    ...
    items: [
      { name: "Bacardi White Rum", price: '$11' },
      { name: "Denizen 3yr White Rum", price: '$11' },
      { name: 'Denizen 8yr Reserve', price: '$10' },
      { name: 'Gosling Black Seal', price: '$12' },
      { name: 'Bacardi White Rum', price: '$11' },
      { name: 'Malibu Coconut', price: '$12' },
      { name: 'Fords', price: '$11' },
      { name: 'Bombay Sapphire', price: '$12' },
      { name: 'Bombay Bramble', price: '$12' },
      { name: 'Empress 1908', price: '$14' },
      { name: 'Monkey 47', price: '$16' },
      { name: 'Tanqueray 10', price: '$13' },
      { name: 'Hendrix', price: '$15' },
      { name: 'Engine', price: '$12' },
      { name: 'Oxley', price: '$12' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Titos', price: '$14' },
      { name: 'Uncle Ed’s Dragonfuit', price: '$10' },
      { name: 'Ilegal Joven', price: '$11' },
      { name: 'Union Mezcal', price: '$12' },
      { name: 'Del Maguey Vida', price: '$13' },
      { name: 'El Jolgorio Cuixe', price: '$15' },
      { name: 'El Jolgorio Madrecuixe', price: '$22' },
...
export const LUXURY = [
  {
    name: 'Luxury',
    items: [
      { name: 'Angels Envy', price: '$18' },
      { name: 'Angels Envy Rye', price: '$20' },
      { name: 'Basil Hayden', price: '$16' },
      { name: '*blantons Single Barrel', price: '$25' },
      { name: 'Buchananas 12 Yr', price: '$18' },
      { name: 'Buffalo Trace', price: '$13' },
      { name: 'Crown Royal', price: '$12' },
      { name: 'Hakushu 12 Yr', price: '$35' },
      { name: 'Highwest Bourbon', price: '$14' },
      { name: 'Highwest Rendezvous', price: '$18' },
      { name: 'Jack Daniels Single Barrel', price: '$18' },
      { name: 'Jameson', price: '$13' },
      { name: 'Jonnie Walker Black', price: '$15' },
      { name: 'Jonnie Walker Blue', price: '$45' },
      ...
      { name: 'Nikka Barrel', price: '$30' },
      { name: 'Nikka Coffey', price: '$22' },
      { name: 'Skrewball', price: '$13' },
      { name: 'Suntory Toki', price: '$16' },
      { name: 'Suntory Habiki Harmony', price: '$22' },
      { name: '**weller Special Reserve', price: '$30' },
      { name: 'Whistle Pig Piggy Back 6yr', price: '$18' },
      { name: 'Whistle Pig 12 Yr', price: '$28' },
      { name: 'Nikka Barrel', price: '$120' },
    ],
  },
];
...
export const WINE_DATA = {
  bubbles: [
    ...
    { name: 'Chandon', region: 'Brut, Sparkling Wine', price: '$13 / $52', label: 'glass / bottle' },
    { name: 'Chandon', region: 'Brut Rosé, Sparkling Wine', price: '$13 / $52', label: 'glass / bottle' },
    { name: 'Veuve Clicquot', region: 'Yellow Label Brut, Champagne', price: '— / $160', label: 'bottle' },
    { name: 'Veuve Clicquot', region: 'Brut Rosé, Champagne', price: '— / $160', label: 'bottle' },
    { name: 'Moët & Chandon', region: 'Imperial Brut, Champagne', price: '— / $180', label: 'bottle' },
    { name: 'Moët & Chandon', region: 'Nectar Rosé, Champagne', price: '— / $175', label: 'bottle' },
  ],
  white: [
  ...
  red: [
    ...
    { name: 'Golden West Vineyard', region: 'Pinot Noir, Washington', price: '$ 14 / 56', label: 'glass / bottle' },
    { name: 'Castello di Volpaia', region: 'Chianti Classico, Tuscany', price: '$16 / $64', label: 'glass / bottle' },
    { name: 'AXR', region: 'Proprietary Red, Napa', price: '$ 17 / 70', label: 'glass / bottle' },
    ...
    { name: 'Far Mountain “Fisson”', region: 'Cabernet Sauvignon, Sonoma', price: '— / $130', label: 'bottle' },
    ...
    { name: 'J. Davies', region: 'Cabernet Sauvignon, Napa Valley', price: '— / $165', label: 'bottle' },
